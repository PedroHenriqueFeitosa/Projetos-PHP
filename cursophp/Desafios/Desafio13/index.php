...
<body>
    ...
    <main>
        ...
        <input type="number" name="saque" id="saque" step="0" required value="<?=$saque?>"> 
        <p style="font:size 0.7em"><sup>*</sup>Notas disponiveis: R$100, R$50,R$20,R$10,R$5 e R$2</p>
    ...
    ?>
    <section>
        <h2>Saque de R$<strong><?=number_format($saque,2,",",".")?> </strong> realizado </h2>
        ...
        <li><img src="imagens/20-reais.jpg" alt="Nota de 20" class="nota">x<?=$tot20?> 
