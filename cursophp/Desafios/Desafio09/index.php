...
<body>
    ...
    <section>
        ...
        <ul>
            <li>A <strong>Média Aritmética Simples</strong> entre os valores e igual a <?=number_format($ma,2,",",".")?>.</li>
            <li> A <strong>Média Aritmética Ponderada </strong> com pesos <?=$peso1?> e <?$peso2?> é igual a <?=number_format($ma,2,",",".")?>.</li>
</ul>
    </section>
</body>
</html>